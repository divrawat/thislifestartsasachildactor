...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const DESCRIPTION = `Read ${MANGA_NAME} chapter ${chapterNumber} online. Alex Summers, a young actor catapulted into the glittering world of Hollywood at an early age. As Alex navigates the highs and lows of fame, the novel explores their personal growth, relationships, and the challenges of maintaining authenticity amidst the pressures of stardom. Through Alex's experiences, the story delves into themes of ambition, identity, and the transformative power of success in the entertainment industry.`
